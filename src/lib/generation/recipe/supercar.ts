...
export const SUPERCAR: AssetRecipe = AssetRecipeSchema.parse({
  ...
  steps: [
    // ---------------------------------------------------------------- body --
    {
      op: 'loft',
      id: 'lower_body',
      note: 'The main volume, from rear bumper to nose. Reading the z values down is reading the side elevation. The body is deliberately narrower than the track: a body as wide as the wheels leaves the tyres flush with the flanks and invisible, which defeats the arch cut entirely.',
      sections: [
        { at: [0, 0.42, -2.3], profile: { type: 'superellipse', radiusX: 0.36, radiusY: 0.14, exponent: 3.4, segments: 24 } },
        { at: [0, 0.44, -2.18], profile: { type: 'superellipse', radiusX: 0.66, radiusY: 0.26, exponent: 3.2, segments: 24 } },
        { at: [0, 0.44, -1.95], profile: { type: 'superellipse', radiusX: 0.78, radiusY: 0.33, exponent: 3.0, segments: 24 } },
        { at: [0, 0.44, -1.45], profile: { type: 'superellipse', radiusX: 0.84, radiusY: 0.37, exponent: 2.7, segments: 24 } },
        { at: [0, 0.43, -0.85], profile: { type: 'superellipse', radiusX: 0.76, radiusY: 0.36, exponent: 2.6, segments: 24 } },
        { at: [0, 0.42, -0.2], profile: { type: 'superellipse', radiusX: 0.74, radiusY: 0.35, exponent: 2.6, segments: 24 } },
        { at: [0, 0.4, 0.5], profile: { type: 'superellipse', radiusX: 0.75, radiusY: 0.33, exponent: 2.7, segments: 24 } },
        { at: [0, 0.38, 1.15], profile: { type: 'superellipse', radiusX: 0.82, radiusY: 0.31, exponent: 2.8, segments: 24 } },
        { at: [0, 0.34, 1.7], profile: { type: 'superellipse', radiusX: 0.74, radiusY: 0.26, exponent: 3.0, segments: 24 } },
        { at: [0, 0.3, 2.08], profile: { type: 'superellipse', radiusX: 0.58, radiusY: 0.19, exponent: 3.2, segments: 24 } },
        { at: [0, 0.27, 2.28], profile: { type: 'superellipse', radiusX: 0.3, radiusY: 0.1, exponent: 3.4, segments: 24 } },
      ],
      material: 'paint',
    },
    {
    ...
    },
    {
      ...
      apply: { rotate: { axis: [0, 0, 1], degrees: 90 }, translate: [-0.72, 0.44, 1.42] },
    },
    {
      op: 'transform',
      id: 'arch_fr',
    ...
    },
    {
      ...
      source: 'arch_cutter_y',
      apply: { rotate: { axis: [0, 0, 1], degrees: 90 }, translate: [-0.76, 0.44, -1.42] },
    },
    {
      op: 'transform',
      id: 'arch_rr',
    ...
    },
    {
      op: 'transform',
      id: 'wheel',
      note: 'The wheel turned so its axle runs across the car, which is the orientation all four placements assume.',
      source: 'wheel_z',
      apply: { rotate: { axis: [0, 1, 0], degrees: 90 } },
    },

    {
      ...
      source: 'wheel',
      apply: { translate: [-0.845, 0.42, 1.42] },
    },
    {
      op: 'transform',
      id: 'wheel_fr',
    ...
    },
    {
      ...
      source: 'wheel',
      apply: { translate: [-0.875, 0.42, -1.42] },
    },
    {
      op: 'transform',
      id: 'wheel_rr',
