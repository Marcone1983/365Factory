...
export const JEEP: AssetRecipe = AssetRecipeSchema.parse({
  ...
  steps: [
    ...
    },
    {
      op: 'loft',
      id: 'cabin',
      note: 'The cabin box, from the almost-vertical windscreen base to the flat roof. The windscreen rakes back only 0.18m over 0.62m of height, which is roughly 16 degrees off vertical — a road car is nearer 60.',
      sections: [
        { at: [0, 1.2, 0.42], profile: { type: 'superellipse', radiusX: 0.8, radiusY: 0.04, exponent: 8, segments: 20 } },
        { at: [0, 1.4, 0.3], profile: { type: 'superellipse', radiusX: 0.82, radiusY: 0.22, exponent: 8, segments: 20 } },
        { at: [0, 1.78, 0.24], profile: { type: 'superellipse', radiusX: 0.84, radiusY: 0.24, exponent: 8, segments: 20 } },
        { at: [0, 1.82, -1.5], profile: { type: 'superellipse', radiusX: 0.84, radiusY: 0.24, exponent: 8, segments: 20 } },
        { at: [0, 1.8, -1.86], profile: { type: 'superellipse', radiusX: 0.8, radiusY: 0.22, exponent: 7, segments: 20 } },
      ],
      material: 'glass',
    },
    {
