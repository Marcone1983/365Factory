...
export const AVATAR: AssetRecipe = AssetRecipeSchema.parse({
  ...
  steps: [
    // ----------------------------------------------------------------- head --
    {
      ...
      sections: [
        { at: [0, 1.664, -0.094], profile: { type: 'ellipse', radiusX: 0.024, radiusY: 0.03, segments: 24 } },
        { at: [0, 1.664, -0.08], profile: { type: 'ellipse', radiusX: 0.05, radiusY: 0.062, segments: 24 } },
        { at: [0, 1.664, -0.06], profile: { type: 'ellipse', radiusX: 0.068, radiusY: 0.09, segments: 24 } },
        { at: [0, 1.664, -0.032], profile: { type: 'ellipse', radiusX: 0.0765, radiusY: 0.106, segments: 24 } },
        { at: [0, 1.664, 0.0], profile: { type: 'ellipse', radiusX: 0.0785, radiusY: 0.114, segments: 24 } },
        { at: [0, 1.664, 0.03], profile: { type: 'ellipse', radiusX: 0.0775, radiusY: 0.114, segments: 24 } },
        { at: [0, 1.664, 0.054], profile: { type: 'ellipse', radiusX: 0.0735, radiusY: 0.112, segments: 24 } },
        { at: [0, 1.664, 0.07], profile: { type: 'ellipse', radiusX: 0.0685, radiusY: 0.106, segments: 24 } },
        { at: [0, 1.664, 0.082], profile: { type: 'ellipse', radiusX: 0.059, radiusY: 0.096, segments: 24 } },
        { at: [0, 1.664, 0.09], profile: { type: 'ellipse', radiusX: 0.043, radiusY: 0.076, segments: 24 } },
        { at: [0, 1.664, 0.095], profile: { type: 'ellipse', radiusX: 0.022, radiusY: 0.046, segments: 24 } },
      ],
      material: 'skin',
    },
    {
